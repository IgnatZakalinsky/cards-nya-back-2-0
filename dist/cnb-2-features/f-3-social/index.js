...
social.get('/users', findUserByToken_1.findUserByToken(getUsers_1.getUsers, 'getUsers'));
social.get('/user', findUserByToken_1.findUserByToken(getUser_1.getUser, 'getUser'));
